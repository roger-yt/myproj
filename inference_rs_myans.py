...
import argparse
import torch
from utils import extract_answer_myans, math_equal
...
if __name__ == "__main__":
    ...
    dataset_ = dataset_.map(task_config.inference_myans_tokenize(tokenizer), num_proc=16)
    ...
    def generate_rational(few_shot_questions, answers, answer_nums):
        ...
        for i, answer_text in enumerate(answers):
            ...
            for rational in rationals:
                ...
                extract_ans = extract_answer_myans(rational_text, data_name)
