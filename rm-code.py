...
class rm_code():
    ...
    #    return {
    #                'task_id': [task_data["task_id"] for task_data in self.task_data.items()],
    #                'prompt': [self.format_prompt(task_data['instruction'],task_data['testcase'][0]) for task_data in self.task_data.items()]
    #            }
